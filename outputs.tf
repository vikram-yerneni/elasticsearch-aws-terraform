...
output "domain_arn" {
  value       = join("", aws_elasticsearch_domain.elasticsearch_domain.*.arn)
  description = "ARN of the Elasticsearch domain"
}

output "domain_id" {
  value       = join("", aws_elasticsearch_domain.elasticsearch_domain.*.domain_id)
  description = "Unique identifier for the Elasticsearch domain"
}

output "domain_name" {
  value       = join("", aws_elasticsearch_domain.elasticsearch_domain.*.domain_name)
  description = "Name of the Elasticsearch domain"
}

output "domain_endpoint" {
  value       = join("", aws_elasticsearch_domain.elasticsearch_domain.*.endpoint)
  description = "Domain-specific endpoint used to submit index, search, and data upload requests"
}

output "kibana_endpoint" {
  value       = join("", aws_elasticsearch_domain.elasticsearch_domain.*.kibana_endpoint)
